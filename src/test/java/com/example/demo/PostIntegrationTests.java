...
public class PostIntegrationTests {
    ...
    public void testPostsIndex() throws Exception {
        ...
        // Makes a Get request to /post and verifies that we get some of the static text of the post/index.html template and at least the title from the first Post is present in the template.
        this.mvc.perform(get("/posts"))
                .andExpect(status().isOk())
                // Test the static content of the page
                .andExpect(content().string(containsString("<h2 class=\"text-center mt-1\">All Posts</h2>")))
                // Test the dynamic content of the page
